...
class AttachmentTest < Test::Unit::TestCase
  ...
  context "when generators and procesors are provided" do
    ...
    teardown { Paperclip.clear_processors! }

    should "process the original, run the generator, then process the resulting files" do
      rebuild_model(
    ...
    should "use the original for styles not generated by the generator" do
      rebuild_model(
        styles: {original: {suffix: 'o'}, a: {suffix: 'a'}, b: {suffix: 'b'}},
