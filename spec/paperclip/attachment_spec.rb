...
describe Paperclip::Attachment do
  ...
  context "when generators and procesors are provided" do
    ...
    it "process the original, run the generator" do
      rebuild_model(
        styles: {
          original: { suffix: "o" }, a: { suffix: "a" }, b: { suffix: "b" }
        },
    ...
    it "use the original for styles not generated by the generator" do
      rebuild_model(
        styles: {
          original: { suffix: "o" }, a: { suffix: "a" }, b: { suffix: "b" }
        },
    ...
    context "An attachment with erroring generator" do
      before do
        rebuild_model(
          :generator => :test_full_generator,
          :styles => { :small => "" }, :whiny_thumbnails => true
        )
        @dummy = Dummy.new
        TestFullGenerator.expects(:make).raises(
          Paperclip::Error, "cannot be processed."
        )
        @file = StringIO.new("...")
