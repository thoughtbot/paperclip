...
describe Paperclip::Attachment do
  ...
  context "when generators and procesors are provided" do
    ...
    it "processes the original, runs the generator, then processes the resulting files" do
      rebuild_model(
        styles: {original: {suffix: 'o'}, a: {suffix: 'a'}, b: {suffix: 'b'}},
        generator: :test_full_generator,
        processors: [:test_processor],
      )
      tempfile = Tempfile.open('paperclip-test') { |f| f.print '.'; f }
    ...
    context "an attachment with a failing generator" do
      before do
        ...
        @dummy = Dummy.new
        TestFullGenerator.expects(:make).raises(Paperclip::Errors::NotIdentifiedByImageMagickError, "cannot be processed.")
        @file = StringIO.new("...")
