...
In your migrations:
  ...
  class AddAvatarColumnsToUser < ActiveRecord::Migration
    def self.up
      ...
      add_column :users, :avatar_file_some_hexdigest,    :string
      add_column :users, :avatar_file_another_hexdigest, :string
    ...
    def self.down
      ...
      remove_column :users, :avatar_file_some_hexdigest
      remove_column :users, :avatar_file_another_hexdigest
...
<attachment>_file_size, some hexdigests (<attachment>_file_*_hexdigest),
<attachment>_content_type, and <attachment>_updated_at.
...
Hexdigests can be MD5, RIPEMD-160, SHA1, SHA256, SHA384, SHA512, Tiger and Whirlpool.
